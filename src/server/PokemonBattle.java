                            ...
                            case ATTACK:
                                ...
                                if (theAtk == null) { //simple walk to monster -> atk -> walk back
                                    ...
                                    if (shouldAdd) { //walk up to the required range of the attack
                                        ...
                                        map.broadcastMessage(MobPacket.moveMonster(false, (byte) -1, 0, 0, 0, 0, battlers[i].getMonster().getObjectId(), startPos, moves2));
                                    }
                                ...
                                if (mPos == null) {
                                    map.broadcastMessage(MobPacket.moveMonster(skillByte > 0, skillByte, 0, 0, 0, 0, battlers[i].getMonster().getObjectId(), startPos, moves));
                                    moves.clear();
                                }
                                EtcTimer.getInstance().schedule(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (mPos != null) {
                                            map.broadcastMessage(MobPacket.moveMonster(skillByte > 0, skillByte, 0, 0, 0, 0, battlers[i].getMonster().getObjectId(), mPos, moves));
                                            moves.clear();
                                        }
                                        ...
                                        if (basedamage != 0) {
                                            ...
                                            if (basedamage > 1) {
                                                ...
                                                map.broadcastMessage(MobPacket.moveMonster(true, skillByte2, 0, 0, 0, 0, battlers[i == 1 ? 0 : 1].getMonster().getObjectId(), battlers[i == 1 ? 0 : 1].getMonster().getTruePosition(), moves));
                                            }
